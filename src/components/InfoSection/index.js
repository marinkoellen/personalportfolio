    ...
    <>
      <InfoContainer id='about'>
        ...
        <InfoWrapper>
          ...
          <AboutMeSubtitle>Shortly after graduating with a bachelor in Maths & Statistics (Hons), I joined the Technology function at BHP.  <br></br>In this role, I enjoy researching and designing creative solutions using statistics, machine learning and data visualisation to help address business challenges. </AboutMeSubtitle>
